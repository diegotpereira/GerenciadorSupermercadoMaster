...
public class TelaCaixa extends JFrame{
	...
	String caminho = "C:\\Users\\T.I\\Desktop\\Cadastro\\BDProdutos.txt";
	static String pagamento = "C:\\Users\\T.I\\Desktop\\Cadastro\\BDPagamento.txt";
	public int aux = 0;
	double sub = 0;
		...
		btnFinalizarCompra.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (!txtLista.getText().isEmpty() && !txtSubtotal.getText().isEmpty()) {
					...
					TelaPagamento tela = new TelaPagamento(pagamento, txtSubtotal.getText(), frame);
...
// *****************************************
				String senha = JOptionPane.showInputDialog(null, "Digite a senha :");
				if (senha.equals("12345")) {
					CadastroProdutos tela = new CadastroProdutos(caminho, frame);
					tela.setVisible(true);
					setVisible(false);
				} else {
					JOptionPane.showMessageDialog(null, "Senha incorreta!", null, ERROR_MESSAGE);
